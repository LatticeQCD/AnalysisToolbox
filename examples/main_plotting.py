...
plot_file("../tests/statistics/wurf.dat", 0, 2, 3, 1, style="dots", label="$\\chi_{\\rm wurf}$", marker='o')
...
plot_file("../tests/statistics/wurf.dat", 0, 2, 3, 1, style="lines", label="quadratic", marker = 'o')
plot_file("example_files/data1.txt", 0, 1, 2, 3, label="gauss noise", xlabel="$\\frac{1}{z}$", capsize = 2)
plot_file("example_files/data2.txt", 0, 1, 2, 3, style="fill", alpha=0.3, label="linear")
plot_file("example_files/data3.txt", 0, 1, 2, 3, style="fill", alpha=0.9, label="linear 2", legendpos = "best", capsize = 2)
...
bareCorr = readGPL('example_files/hist2.gpx')
factor   = 9*8.3724494170096e-08
data2    = bareCorr[:,6]*factor
bareCorr = readGPL('example_files/hist1.gpx')
data1    = bareCorr[:,6]
