...
if args.obs == "chi":
    ...
    if LCP_file is None:
        ...
        writeTable("chiBQSC%s_%s.txt"%(args.BQSC,LCP_file), T, muBh, chi_pdg, chi_QM, header=['T [MeV]','muB/T', 'PDG-HRG','QM-HRG'])
    ...
    if LCP_file is None:
        ...
        writeTable("P_div_T4_%s.txt"%LCP_file,T,muBh, p_QM, p_pdg,header=['T [MeV]','muB/T','PDG-HRG','QM-HRG'])
