...
#
# Test: Calculate the pressure and compare it with PHYSICAL REVIEW D 90, 094503 (2014). This gets a slightly higher
#       error tolerance because I had to fish the values out with Webplotdigitizer.
#
