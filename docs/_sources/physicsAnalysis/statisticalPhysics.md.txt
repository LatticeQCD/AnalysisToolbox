...
There is a base `UniversailtyClass` object from which all universality classes inherit. It holds critical exponents
as attributes along with an `exponentSummary()` method that prints to screen all critical exponents. If you want to
access 3$d$, $\mathbb{Z}_2$ critical exponents, you can simply use
```Python
univ = Z2_3d
univ.alpha
```
