...
if __name__ == '__main__':
    ...
    #           % (beta, args.T, args.nt, sq.a_r1_invGeV(beta, args.year)))
        ...
        print("Beta: %f \t T: %fGeV \t TbyTc: %f \t nt: %i \t a: %f 1/GeV \t a: %f fm \t Tc: 0.154 GeV"
              % (args.beta, get_T_GeV(args.beta, args.nt, args.year), get_T_GeV(args.beta, args.nt, args.year)/0.180, args.nt, sq.a_r1_invGeV(args.beta, args.year), sq.GeVinv_to_fm(sq.a_r1_invGeV(args.beta, args.year))))
    else:
