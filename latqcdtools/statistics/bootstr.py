...
class nimbleGaussianBoot:
    ...
    def __init__(self, func, data, data_std_dev, numb_samples, sample_size, same_rand_for_obs,
        return_sample, seed, err_by_dist, useCovariance, args, parallelize, nproc, asym_err):
...
def bootstr_from_gauss(func, data, data_std_dev, numb_samples, sample_size = 1, same_rand_for_obs = False, return_sample = False, seed = None,
                       err_by_dist = False, useCovariance = False, args = (), parallelize = True, nproc = 32, asym_err=False):
    ...
    bts_gauss = nimbleGaussianBoot(func, data, data_std_dev, numb_samples, sample_size, same_rand_for_obs, return_sample, seed,
                                   err_by_dist, useCovariance, args, parallelize, nproc, asym_err)
