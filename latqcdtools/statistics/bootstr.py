...
def bootstr_from_gauss(func, data, data_std_dev, numb_samples, sample_size = 1, return_sample = False, seed = None,
                       err_by_dist = False, useCovariance = False, args = (), parallelize = True, nproc = 32):
    ...
    bts_gauss = nimbleGaussianBoot(func, data, data_std_dev, numb_samples, sample_size, return_sample, seed,
                                   err_by_dist, useCovariance, args, parallelize, nproc)
