...
filepath_charm="../latqcdtools/physics/hadron_list_ext_strange_charm_2020.txt"
...
# Here's where you can actually use it.
python3 main_charm.py --hadron_file  ${filepath} --tag QMHRG2020_BI_charm --obs chi --bqs 1011 --temperature_range 130:180:0.5
