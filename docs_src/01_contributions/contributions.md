...
This section contains some hints and guidelines on how to contribute to the AnalysisToolbox. The minimal protocol you should follow when contributing to the code is as follows:
